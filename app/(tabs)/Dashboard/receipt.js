  ...
  return (
    <View style={{ paddingTop: getStatusBarHeight(), backgroundColor: '#fff', flex: 1 }}>
      ...
      <ScrollView style={styles.container}>
        ...
        Dear Customer, You have successfully shared {transactionData.desc} to {transactionData.phone} Thank you.
                </Text>
        </View>
        ...
        <View style={styles.detailsContainer}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>{transactionData.network}</Text>
          </View>
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Description:</Text>
            <Text style={styles.detailValue}>{transactionData.desc}</Text>
          </View>
          <View style={styles.detailRow}>
