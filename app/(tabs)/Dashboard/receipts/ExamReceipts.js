          ...
          <body>
            ...
            <div class="details">
              ...
              <div class="detail-row">
                ...
                <span class="value">Purchase of ${transactionData.providerName} Pin</span>
              </div>
        <div class="detail-row">
                <span class="label">Quantity:</span>
                <span class="value"> ${transactionData.quantity} </span>
              </div>
            <div class="detail-row">
  ...
  return (
    <View style={{ paddingTop: getStatusBarHeight(), backgroundColor: '#fff', flex: 1 }}>
      ...
      <ScrollView style={styles.container}>
        ...
        Dear Customer, You have successfully Purchase {transactionData.providerName} Pin Thank you for using Insighthub.
                </Text>
        </View>
        ...
        <View style={styles.detailsContainer}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>{transactionData.quantity}</Text>
          </View>
          <View style={styles.detailRow}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue } numberOfLines={3}>Purchase of {transactionData.providerName} Pin</Text>
          </View>
