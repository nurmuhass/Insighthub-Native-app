  ...
  return (
    <View style={{ paddingTop: getStatusBarHeight(), backgroundColor: '#fff', flex: 1 }}>
      ...
      <ScrollView style={styles.container}>
        ...
        Dear Customer, You have successfully Purchase {transactionData.cabledetails} Thank you for using Insighthub.
                </Text>
        </View>
        ...
        <View style={styles.detailsContainer}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue } numberOfLines={3}>{transactionData.cabledetails}</Text>
          </View>
          <View style={styles.detailRow}>
